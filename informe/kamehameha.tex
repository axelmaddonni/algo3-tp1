...
\begin{figure}[H]
 \centering
	\includegraphics[width=0.9\textwidth]{img/tiempos/kamehameha2.pdf}
...
\begin{figure}[H]
 \centering
	\includegraphics[width=0.9\textwidth]{img/tiempos/kamehameha1.pdf}
	\caption{\footnotesize Tiempo que toma el algoritmo en $\mu$s para una entrada de tamaño $n$.}
...
\begin{figure}[H]
 \centering
	\includegraphics[width=0.9\textwidth]{img/tiempos/kamehameha3.pdf}
	\caption{\footnotesize Tiempo que toma el algoritmo en $\mu$s para una entrada de tamaño $n$.}
...
\begin{figure}[H]
 \centering
	\includegraphics[width=0.9\textwidth]{img/tiempos/kamehameha4.pdf}
	\caption{\footnotesize Tiempo que toma el algoritmo en $\mu$s para una entrada de tamaño $n$.}
